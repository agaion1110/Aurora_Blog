...
<figure><img src="@source/index/分类/assets/6.gif" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p><img src="@source/index/分类/assets/7.png" alt="img" loading="lazy"><img src="data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==" alt="点击并拖拽以移动" loading="lazy">编辑</p>
...
<p><img src="@source/index/分类/assets/8.png" alt="img" loading="lazy"><img src="data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==" alt="点击并拖拽以移动" loading="lazy">编辑</p>
<p>代码：</p>
...
<p>我们可以使用JavaScript的对象XMLHttpRequest来实现原生Ajax，但这种方法比较复杂，不易编写。jQuery已经封装了Ajax，使得发起Ajax请求比较容易，这里我们首先需要在<head>标记中引入jQuery.js文件。例如：</p>
...
<figure><img src="@source/index/分类/assets/9.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p><img src="data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==" alt="点击并拖拽以移动" loading="lazy">编辑</p>
