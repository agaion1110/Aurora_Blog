...
<h2 id="promise概念" tabindex="-1"><a class="header-anchor" href="#promise概念" aria-hidden="true">#</a> Promise概念</h2>
<p><strong><code v-pre>Promise</code></strong> 对象表示异步操作最终的完成（或失败）以及其结果值。</p>
...
<p>指定回调函数的方式更加灵活</p>
<ul>
<li>不使用promise的回调函数：必须在启动异步任务前指定</li>
<li>使用promise的回调函数：启动异步任务=&gt;返回promie对象=&gt;给promise对象绑定回调函数（甚至可以在异步任务结束后指定/多个）</li>
</ul>
</li>
<li>
...
<li>
<p>回调地狱的缺点</p>
<p>不便于阅读、不便于异常处理、不利于维护</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//有多个异步任务，要求需要同时拿到所有异步任务的结果，下边就是用回调地狱</span>
...
<p>解决方案</p>
<p>promise链式调用</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> myPromise <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Promise</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">resolve<span class="token punctuation">,</span> reject</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code> $<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/server'</span><span class="token punctuation">,</span><span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span><span class="token operator">=></span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>定时器</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="promise的状态" tabindex="-1"><a class="header-anchor" href="#promise的状态" aria-hidden="true">#</a> Promise的状态</h2>
<ul>
<li>一个 <code v-pre>Promise</code> 必然处于以下几种状态之一：
<ul>
...
<h2 id="promise-对象的值" tabindex="-1"><a class="header-anchor" href="#promise-对象的值" aria-hidden="true">#</a> Promise 对象的值</h2>
<p>实例对象中的另一个属性 『PromiseResult』</p>
<p>保存着异步任务『成功 / 失败』的结果</p>
<ul>
<li>resolve</li>
<li>reject</li>
</ul>
<h2 id="promise的基本流程" tabindex="-1"><a class="header-anchor" href="#promise的基本流程" aria-hidden="true">#</a> promise的基本流程</h2>
<figure><img src="@source/文章/分类/js/Promise/assets/image-20230720170035179.png" alt="image-20230720170035179" tabindex="0" loading="lazy"><figcaption>image-20230720170035179</figcaption></figure>
<h2 id="如何使用promise" tabindex="-1"><a class="header-anchor" href="#如何使用promise" aria-hidden="true">#</a> 如何使用Promise</h2>
<ul>
<li>Promise构造函数：Promise(<code v-pre>excutor</code>){}</li>
<li>executor：执行器   (resolve,reject)=&gt;{}
<ul>
<li>resolve函数：内部定义成功时我们调用的函数value=&gt;{}</li>
<li>reject函数：内部定义失败时我们调用的函数reason=&gt;{}</li>
</ul>
</li>
</ul>
<p><strong>说明：executor会在Promise内部立即同步调用，异步操作在执行器中执行</strong></p>
<ul>
<li>
<p><code v-pre>Promise.prototype.then</code>方法：(onResolved,onRejected)=&gt;{}</p>
<ul>
<li>onResolved函数：成功的回调函数(value)=&gt;{}</li>
<li>onRejected函数：失败的回调函数(reason)=&gt;{}</li>
</ul>
<p><strong>说明：指定用于得到成功value的成功回调和用于得到失败reason的失败回调返回一个新的promise对象</strong></p>
</li>
<li>
<p><code v-pre>Promise.prototype.catch</code>方法：(onRejected)=&gt;{}
*  onRejected函数：失败的回调函数（resson）=&gt;{}</p>
</li>
</ul>
<p>​		<strong>说明：then的语法糖，相当于：then(undefined,onRejected)</strong></p>
<ul>
<li><code v-pre>Promise.resolve</code>方法：(value)=&gt;{}
<ul>
<li>value:成功的数据或promise对象</li>
</ul>
</li>
</ul>
<p>​		<strong>说明：返回一个成功/失败的promise对象（当传入promise对象是，该方法的返回值与传入对象的结果一致）</strong></p>
<ul>
<li>
<p><code v-pre>Promise.reject</code>方法：(reason)=&gt;{}</p>
<ul>
<li>reason:失败的原因</li>
</ul>
<p><strong>说明：返回一个失败的promise对象（不管传什么都是返回一个失败的promise对象）</strong></p>
</li>
<li>
<p><code v-pre>Promise.all</code>方法：(promises)=&gt;{}</p>
</li>
<li>
<p>promises:包含n个promise的数组</p>
</li>
</ul>
<p><strong>说明：返回一个新的promise,只有所有的promise都成功才成功，只要有一个失败了就直接失败</strong></p>
<ul>
<li>
<p><code v-pre>Promise.race</code>方法：(promises)=&gt;{}</p>
</li>
<li>
<p>promises:包含n个promise的数组</p>
</li>
