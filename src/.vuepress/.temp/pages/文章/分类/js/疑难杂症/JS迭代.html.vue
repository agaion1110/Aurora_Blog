...
<h2 id="迭代协议" tabindex="-1"><a class="header-anchor" href="#迭代协议" aria-hidden="true">#</a> 迭代协议</h2>
<p><strong>迭代协议</strong>并不是新的内置实现或语法，而是<em>协议</em>。这些协议可以被任何遵循某些约定的对象来实现。</p>
<blockquote>
<p>ES6新增了<code v-pre>Set</code>、<code v-pre>Map</code>类型，他们和<code v-pre>Array</code>、<code v-pre>Object</code>类型很像，<code v-pre>Array</code>、<code v-pre>Object</code>都是可以遍历的，但是<code v-pre>Set</code>、<code v-pre>Map</code>都不能用<code v-pre>for</code>循环遍历，解决这个问题有两种方案，一种是<strong>为Set、Map单独新增一个用来遍历的API</strong>，另一种是<strong>为Set、Map、Array、Object新增一个统一的遍历API</strong>。</p>
<p>ES6选择使用一种设计标准，来统一所有可遍历类型的遍历方式。<code v-pre>Iterator</code>正是这样一种标准。</p>
</blockquote>
<p>迭代协议具体分为两个协议：<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Iteration_protocols#%E5%8F%AF%E8%BF%AD%E4%BB%A3%E5%8D%8F%E8%AE%AE" target="_blank" rel="noopener noreferrer">可迭代协议<ExternalLinkIcon/></a><code v-pre>(Iterable Protocols)</code>和<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Iteration_protocols#%E8%BF%AD%E4%BB%A3%E5%99%A8%E5%8D%8F%E8%AE%AE" target="_blank" rel="noopener noreferrer">迭代器协议<ExternalLinkIcon/></a><code v-pre>(Iterator Protocols)</code>。</p>
<h3 id="可迭代协议-iterable" tabindex="-1"><a class="header-anchor" href="#可迭代协议-iterable" aria-hidden="true">#</a> 可迭代协议 | Iterable</h3>
<blockquote>
<p><strong>可迭代协议允许 JavaScript 对象定义或定制它们的迭代行为</strong></p>
<p><strong>要成为可迭代对象， 一个对象必须实现 <code v-pre>@@iterator</code> 方法。这意味着对象（或者它原型链上的某个对象）必须有一个键为</strong> <code v-pre>@@iterator</code> <strong>的属性，可通过常量</strong> <code v-pre>Symbol.iterator</code><strong>访问该属性。</strong></p>
</blockquote>
<p><code v-pre>Symbol.iterator</code> 是一个无参数的函数，其返回值为一个<strong>迭代器</strong>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="符号-symbol" tabindex="-1"><a class="header-anchor" href="#符号-symbol" aria-hidden="true">#</a> 符号 | Symbol</h3>
<blockquote>
<p><strong>ES6 引入了一种新的原始数据类型<code v-pre>Symbol</code>，表示独一无二的值。</strong></p>
<p><strong>Symbol 值通过<code v-pre>Symbol</code>函数生成。这就是说，对象的属性名现在可以有两种类型，一种是原来就有的字符串，另一种就是新增的 Symbol 类型。</strong></p>
<p><strong>凡是属性名属于 Symbol 类型，就都是独一无二的，可以保证不会与其他属性名产生冲突。</strong></p>
</blockquote>
...
<p><strong><code v-pre>Generator</code></strong> 对象由<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Statements/function*" target="_blank" rel="noopener noreferrer">生成器函数<ExternalLinkIcon/></a>返回并且它符合<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Iteration_protocols#%E5%8F%AF%E8%BF%AD%E4%BB%A3%E5%8D%8F%E8%AE%AE" target="_blank" rel="noopener noreferrer">可迭代协议<ExternalLinkIcon/></a>和<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Iteration_protocols#%E8%BF%AD%E4%BB%A3%E5%99%A8%E5%8D%8F%E8%AE%AE" target="_blank" rel="noopener noreferrer">迭代器协议<ExternalLinkIcon/></a>。</p>
<h3 id="生成器函数-function" tabindex="-1"><a class="header-anchor" href="#生成器函数-function" aria-hidden="true">#</a> 生成器函数 | function*</h3>
<p><strong><code v-pre>function*</code></strong> 这种声明方式 (<code v-pre>function</code>关键字后跟一个星号）会定义一个<strong>生成器函数</strong> (generator function)，它返回一个 <a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Generator" target="_blank" rel="noopener noreferrer"><code v-pre>Generator</code><ExternalLinkIcon/></a> 对象。</p>
<p><strong>生成器</strong>（函数）用于生成一个<strong>迭代器</strong>（对象）,<em>还有用于异步编程，熟知的<code v-pre>async/await</code>就是<code v-pre>generator</code>的语法</em></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>语法：</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常用场景" tabindex="-1"><a class="header-anchor" href="#常用场景" aria-hidden="true">#</a> 常用场景</h2>
<p>什么时候会调用 <code v-pre>Symbol.iterator</code> 方法呢？</p>
<h3 id="for-of循环-for-of-iteration" tabindex="-1"><a class="header-anchor" href="#for-of循环-for-of-iteration" aria-hidden="true">#</a> <code v-pre>for-of</code>循环 | <code v-pre>for-of</code> Iteration</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> babys <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'hpy'</span><span class="token punctuation">,</span> <span class="token string">'zs'</span><span class="token punctuation">,</span> <span class="token string">'yxz'</span><span class="token punctuation">,</span> <span class="token string">'hfcj'</span><span class="token punctuation">,</span> <span class="token string">'zpj'</span><span class="token punctuation">,</span> <span class="token string">'cfy'</span><span class="token punctuation">,</span> <span class="token string">'yxx'</span><span class="token punctuation">,</span> <span class="token string">'lyc'</span><span class="token punctuation">,</span> <span class="token string">'zls'</span><span class="token punctuation">,</span> <span class="token string">'yxn'</span><span class="token punctuation">,</span> <span class="token string">'cym'</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="解构赋值-destructuring-assignment" tabindex="-1"><a class="header-anchor" href="#解构赋值-destructuring-assignment" aria-hidden="true">#</a> 解构赋值 | Destructuring Assignment</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="扩展运算符-spread-operator" tabindex="-1"><a class="header-anchor" href="#扩展运算符-spread-operator" aria-hidden="true">#</a> 扩展运算符 | Spread Operator</h3>
<p>扩展运算符是一种简便机制，可以将任何部署了 Iterator 接口的数据结构，转为数组。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其他-the-others" tabindex="-1"><a class="header-anchor" href="#其他-the-others" aria-hidden="true">#</a> 其他 | The Others</h3>
<blockquote>
<ul>
<li><code v-pre>Array.from()</code></li>
<li><code v-pre>Map(), Set(), WeakMap(), WeakSet()</code>（比如<code v-pre>new Map([['a',1],['b',2]])</code>）</li>
<li><code v-pre>Promise.all()</code></li>
<li><code v-pre>Promise.race()</code></li>
<li><code v-pre>yield*</code></li>
</ul>
</blockquote>
<h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2>
<ul>
<li>迭代协议的主要内容，可以用如下接口表示</li>
</ul>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Iterable</span> <span class="token punctuation">{</span>
...
<li>对于<code v-pre>Iterable</code>的对象，可以使用<code v-pre>for-of</code>，<code v-pre>...</code>，<strong>解构赋值</strong>等操作。</li>
</ul>
<h3 id="回顾-review" tabindex="-1"><a class="header-anchor" href="#回顾-review" aria-hidden="true">#</a> 回顾 | Review</h3>
<p>回到开始的问题：</p>
<blockquote>
<ul>
<li><code v-pre>for-in</code>是为了遍历 <strong>键值对</strong>(<code v-pre>key-value</code>)形式的对象的</li>
<li><code v-pre>for-of</code>是为了遍历 所有实现了<strong>迭代协议</strong>的可迭代对象的</li>
</ul>
</blockquote>
</div></template>
