...
<p>在了解组件的自定义事件之前，我们也了解过<code v-pre>props</code>，<code v-pre>props</code>也能实现子组件向父组件通信，接下来展示的将是通过自定义事件完成子传父功能。</p>
<!-- more -->
<h2 id="父组件" tabindex="-1"><a class="header-anchor" href="#父组件" aria-hidden="true">#</a> 父组件：</h2>
<ol>
<li>绑定自定义事件</li>
<li>确定自定义事件具体内容</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="子组件" tabindex="-1"><a class="header-anchor" href="#子组件" aria-hidden="true">#</a> 子组件</h2>
<ol>
<li>触发自定义事件</li>
<li>触发自定义事件的内容</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue2和vue3中的区别" tabindex="-1"><a class="header-anchor" href="#vue2和vue3中的区别" aria-hidden="true">#</a> Vue2和Vue3中的区别</h2>
<p>在自定义事件上，Vue2和Vue3发生了一些变化。</p>
<p>区别：</p>
<ol>
<li>在vue2中，父组件身上给子组件标签元素设置<strong>自定义事件</strong> <code v-pre>&lt;子组件名 @事件名=&quot;方法名&quot; /&gt;</code>，通过这种形势绑定的都是自定义事件，需要通过<code v-pre>.native</code>修饰符变为原生DOM事件。</li>
<li>在vue3中，<code v-pre>&lt;子组件名 @事件名=&quot;方法名&quot; /&gt;</code>这种事件的绑定都是什么类型的事件，首先看子组件<code v-pre>emits</code>中有没有声明，如果声明了，不管事件名是什么都是自定义事件，其次是看事件名是否为原生事件中包含的事件例如：<code v-pre>click</code>等，如果是，那么就是原生DOM事件，不许要<code v-pre>.native</code>修饰符来声明。</li>
</ol>
<p>例如：</p>
<p>Vue2中触发父组件中的子组件标签的原生DOM事件需要添加.native修饰符</p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>event1</span>  <span class="token attr-name">@click.native</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>handler1<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>event1</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Vue3中子组件要发送的自定义事件需要在配置项emits中声明<code v-pre>emits:[&quot;setData&quot;]</code></p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>studyEmits</span> <span class="token attr-name">@setData</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>getData<span class="token punctuation">"</span></span> <span class="token attr-name">@click</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>showAlert<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>studyEmits</span><span class="token punctuation">></span></span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>注意：<code v-pre>click</code>如果没有在子组件<code v-pre>emits</code>中声明就是原生DOM事件.</p>
</div></template>
