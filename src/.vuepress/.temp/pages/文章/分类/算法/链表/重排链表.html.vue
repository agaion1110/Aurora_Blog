<template><div><h1 id="重排链表" tabindex="-1"><a class="header-anchor" href="#重排链表" aria-hidden="true">#</a> 重排链表</h1>
...
<p>示例 1：</p>
<figure><img src="https://pic.leetcode-cn.com/1626420311-PkUiGI-image.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
输出：[1,5,2,4,3]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="解题思路" tabindex="-1"><a class="header-anchor" href="#解题思路" aria-hidden="true">#</a> 解题思路</h2>
<p>由题目分析得知，交换后的链表其实时将原链表的后半部分逆置，并每隔一个插入原链表，直到逆置的链表全部利用完。</p>
